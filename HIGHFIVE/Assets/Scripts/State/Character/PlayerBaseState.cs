...
public class PlayerBaseState : IState
{
    ...
    private void FlipCharacter(Vector2 dir)
    {
        ...
        if (dir.x > 0) { _playerStateMachine._player.transform.localScale = new Vector3(-2.5f, localScale.y, 1); }
        else { _playerStateMachine._player.transform.localScale = new Vector3(2.5f, localScale.y, 1); }
    }
}
